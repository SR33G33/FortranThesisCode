...
580 FORMAT (15 F1.0)
5800 FORMAT (10 F1.0)
WRITE (6,315) "INPUT BETA(N+1)"
READ (5,68) (BETA(I), I=1,6)
WRITE (6,68) (BETA(I), I=1,6)
68 FORMAT (6 F2.0)
...
500 I2=N+L
WRITE (6,315) "INPUT MATRIX A (N,N) AGAIN"
READ (5,58) ((A(I,J), I=1,N), J=1,N)
N1=N+1
IR1=IR+1
M1=M+1
