...
IF (QC(N,J)) 29,19,29
19 CONTINUE
WRITE (108, 801) ’THE SYSTEM IS NOT COMPLETELY CONTROLLABLE’
801 FORMAT (//,5X)
GO TO 1500
29 IC=(J-1)/IR
WRITE (108, 70) ‘MATRIX QC’, ((QC (I,J), J=1,NR), I=1,N)
...
IF (QO(N,J)) 49,39,49
39 CONTINUE
WRITE (108, 901) ‘SYSTEM IS NOT COMPLETELY OBSERVABLE’
901 FORMAT (//, 5X)
GO TO 1500
49 IO=(J-1)/M
WRITE (108, 90) ‘MATRIX QO’ ,((QO(I,J), J=1, NM), I=1,N)
...
311 WRITE (108, 312) ‘MATRIX A IS CYCLICAL’
312 FORMAT (//, 10X)
DO 313 I=1,N
DO 313 J=1,N
313 A1(I,J)=A(I,J)
GO TO 399
314 WRITE (108, 315) ‘MATRIX A IS NOT CYCLICAL, WE APPLY THE DAVISON ALGORITHM’
315 FORMAT (//)
K=2
320 NM=2*N-K
CALL PRIM (RR, Q, N, NM, K)
...
325 WRITE (108, 326) ‘MATRIX Y IS NOT CYCLICAL’
326 FORMAT (//, 10X)
K=2
331 NM=2*N-K
CALL PRIM (RR, Q, N, NM, K)
...
334 S=S+1.
GO TO 336
324 WRITE (108, 340) ‘Y HAS BECOME CYCLICAL’
340 FORMAT (//,10X)
DO 341 I=1,N
DO 341 J=1, N
341 A1 (I,J)=Y(I,J)
...
S=S+1.
GO TO 405
404 WRITE (108, 800) ‘G COULD NOT BE FOUND’
800 FORMAT (//, 5X)
GO TO 1500
401 K=1
S=S+1.3
...
S=S+1.
GO TO 410
409 WRITE (108,900)  ‘T COULD NOT BE FOUND’
900 FORMAT (//, 5X)
GO TO 1500
406 IF (IC-IO) 11, 13, 12
13 IF (IR-M) 11, 11, 12
11 L=IC
WRITE (108, 60) ‘THE NUMBER OF INTEGRATORS’, L , ‘L=IC’
60 FORMAT (20X, I2, 10X)
GO TO 1
12 L=IO
WRITE (108, 80) ‘THE NUMBER OF INTEGRATORS’, L, ‘L=IO’
...
WRITE (108, 600)  ‘ALGORITHM CHECK’
600 FORMAT (20X)
WRITE (108,180) ‘BETA (‘I2’)=’ , (I, BETA (I),  I=1,I2),    ‘ALFA2(‘I2’)=’,     ( I, ALFA2 (I), I=1,I2)
